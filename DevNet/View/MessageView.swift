...
class MessageViewCell: BaseCell {
    ...
    override func setupViews() {
        ...
        profileImageView.image = UIImage(named: "elon_boi.jpg")
        hasReadImageView.image = UIImage(named: "keanu_boi.jpeg")
        ...
        addConstraintsWithFormat(format: "V:[v0(2)]|", views: dividerLineView)
    }
